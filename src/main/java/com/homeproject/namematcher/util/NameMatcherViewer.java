...
public class NameMatcherViewer {
	private final static Logger LOGGER = Logger.getLogger(NameMatcherViewer.class.getName());
	...
	public void getView(String outputDirName) {
        ...
        if (outputDir != null) {
			...
			nameMatcher.getInputFileToNameMatches().forEach((inputFile, uniqueNames) -> {
