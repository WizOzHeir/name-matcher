...
public class UtilTests {
  ...
  public void givenTooLongFileNameWhenValidateThenFails() {
    ...
    assertThrows(IllegalArgumentException.class, () -> isCorrectFileName(fileName), "Invalid directory name");
  }

  @ParameterizedTest
  @NullSource
  public void givenNullInputWhenValidateThenFails(String input) {
    assertThrows(IllegalArgumentException.class, () -> isCorrectInputName(input), "Invalid input");
  }
